// ==============================================================================================================
// Replaces this code using an Simple Factory.
// ==============================================================================================================
//      enum PaymentType
//      {
//          Credit1x,
...
//      }
//      
//      public void Replace_Switch_For_Simple_Factory()
//      {
//          var order = new Order();
//          order.Total = 100;
...
namespace SimpleFactory.UnitTest
{
    [TestClass]
    public class PaymentProcessUnitTest
    {
        ...
        public void Must_Create_Installment_For_Two_Installment_Credit_Operation()
        {
            ...
            var payment = PaymentFactory.PayWithCredit(2);
            payment.CreateInstallments(order);

            Assert.IsNotNull(order.Installments);
            Assert.IsTrue(order.Installments.Count == 2);
            Assert.IsTrue(order.Installments[0].PaymentValue == order.Total / 2);
            Assert.IsTrue(order.Installments[0].DueDate == DateTime.Today.AddMonths(1));
            Assert.IsTrue(order.Installments[1].PaymentValue == order.Total / 2);
